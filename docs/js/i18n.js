...
(function () {
  ...
  const T = {
    ...
    'map.lead':         { en: '25 game locations mapped onto 1940s Shanghai', zh: '25个游戏地点标注于1940年代上海' },
    ...
    'landValue.boardDesc': { en: 'Shanghai Millionaire follows the British Waddington\'s Monopoly template: 40 squares, 8 color groups, prices increasing clockwise from GO. The localization replaces London streets with Shanghai streets while maintaining the price structure.', zh: '上海大富翁遵循英国 Waddington 大富翁模板：40格、8个颜色组、从起点顺时针价格递增。本地化将伦敦街名替换为上海街名，同时保持价格结构。' },
    ...
    'landValue.tierCaption': { en: 'IS = International Settlement. The pink group (Ningpo/Tientsin/Honan) is geographically central but game-priced low — a potential anomaly worth investigating.', zh: 'IS = 公共租界。粉色组（宁波路/天津路/河南路）地理位置中心但游戏价格低——值得调查的潜在异常。' },
    ...
    'landValue.timeline1946': { en: 'Lobel brothers create handmade Shanghai Millionaire in refugee camp. Their choice of this game suggests it was well-known in the international community.', zh: 'Lobel 兄弟在难民营制作手绘上海大富翁。他们选择这款游戏说明它在国际社区中很有名。' },
